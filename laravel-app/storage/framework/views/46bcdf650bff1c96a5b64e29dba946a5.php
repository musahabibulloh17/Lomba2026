            ...
            <div class="stat-card bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-3xl font-bold text-gray-800"><?php echo e($stats['total_tasks']); ?></p>
            ...
            <div class="stat-card bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-3xl font-bold text-green-600"><?php echo e($stats['upcoming_meetings']); ?></p>
            ...
            <div class="stat-card bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-3xl font-bold text-purple-600"><?php echo e($stats['completed_tasks']); ?></p>
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-100 p-6">
                <div class="flex items-center justify-between mb-5">
                    ...
                    <span class="bg-indigo-100 text-indigo-600 text-xs font-semibold px-3 py-1 rounded-full">
                        <?php echo e($recentTasks->count()); ?> Tasks
                    </span>
                </div>
                ...
                <?php else: ?>
                    <div class="space-y-3">
                        <?php $__currentLoopData = $recentTasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="border-l-4 <?php if($task->status === 'completed'): ?> border-green-500 bg-green-50/50 <?php elseif($task->status === 'in_progress'): ?> border-blue-500 bg-blue-50/50 <?php else: ?> border-gray-300 bg-gray-50/50 <?php endif; ?> rounded-r-xl pl-4 pr-3 py-3 hover:shadow-md transition duration-200">
                                <div class="flex items-start justify-between">
                                    <div class="flex-1 mr-2">
                                        <h4 class="font-semibold text-gray-800 mb-1"><?php echo e($task->title); ?></h4>
                                        <p class="text-sm text-gray-600 mb-2"><?php echo e(Str::limit($task->description, 50)); ?></p>
                                        <div class="flex items-center text-xs text-gray-500">
                                            <span class="material-icons text-xs mr-1">schedule</span>
                                            <span>Due: <?php echo e($task->due_date ? $task->due_date->format('M d, Y') : 'No due date'); ?></span>
                                        </div>
                                    </div>
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-100 p-6">
                <div class="flex items-center justify-between mb-5">
                    ...
                    <span class="bg-purple-100 text-purple-600 text-xs font-semibold px-3 py-1 rounded-full">
                        <?php echo e($upcomingMeetings->count()); ?> Meetings
                    </span>
                </div>
                    ...
                    <div class="space-y-3">
                        <?php $__currentLoopData = $upcomingMeetings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $meeting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="border-l-4 border-indigo-500 bg-indigo-50/50 rounded-r-xl pl-4 pr-3 py-3 hover:shadow-md transition duration-200">
                                <div class="flex items-start justify-between">
                                    <div class="flex-1">
                                        <h4 class="font-semibold text-gray-800 mb-1"><?php echo e($meeting->title); ?></h4>
                                        <p class="text-sm text-gray-600 mb-2"><?php echo e(Str::limit($meeting->description, 50)); ?></p>
                                        <div class="flex items-center text-xs text-gray-500">
                                            <span class="material-icons text-xs mr-1">access_time</span>
                                            <span><?php echo e($meeting->start_time->format('M d, Y h:i A')); ?></span>
                                        </div>
                                    </div>
...
<?php /**PATH C:\Users\MUSA\Documents\GitHub\Lomba2026\laravel-app\resources\views/dashboard/index.blade.php ENDPATH**/ ?>