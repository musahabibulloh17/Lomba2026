...
unset($__errorArgs, $__bag); ?>
            ...
            <!-- Google Login Button -->
            <div class="mb-6">
                <a href="<?php echo e(route('auth.google')); ?>" class="w-full flex items-center justify-center px-6 py-3 border-2 border-gray-200 rounded-xl text-gray-700 font-semibold bg-white hover:bg-gray-50 hover:border-gray-300 transition duration-200 shadow-sm hover:shadow group">
            ...
            <div class="text-center">
                <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center justify-center w-full px-6 py-3 border-2 border-indigo-200 text-indigo-600 font-semibold rounded-xl hover:bg-indigo-50 transition duration-200">
...
<?php /**PATH C:\Users\MUSA\Documents\GitHub\Lomba2026\laravel-app\resources\views/auth/login.blade.php ENDPATH**/ ?>