    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="space-y-6">
                ...
                <form action="<?php echo e(route('settings.update.profile')); ?>" method="POST">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="email" name="email" id="email" value="<?php echo e(auth()->user()->email); ?>" disabled
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-100 p-6">
                ...
                <form action="<?php echo e(route('settings.update.notifications')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-green-50 border border-green-200 rounded-xl p-4">
                            <div class="flex items-start">
                                <input type="checkbox" name="whatsapp_notifications" id="whatsapp_notifications" 
                                       value="1" <?php echo e(auth()->user()->whatsapp_notifications ? 'checked' : ''); ?>
                        ...
                        <?php if(auth()->user()->phone_number && auth()->user()->whatsapp_notifications): ?>
                        <div class="bg-blue-50 border border-blue-200 rounded-xl p-4 flex items-start">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-sm text-blue-700 mt-1">
                                    You will receive reminders at: <strong><?php echo e(auth()->user()->phone_number); ?></strong>
                                </p>
                            </div>
                        </div>
                        <?php endif; ?>
                ...
                <div class="space-y-4">
                    <div class="bg-blue-50 border border-blue-200 rounded-xl p-4 flex items-start">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-blue-700 mt-1">
                                You receive email notifications at: <strong><?php echo e(auth()->user()->email); ?></strong>
                            </p>
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-100 p-6">
                ...
                <div class="space-y-4">
                    <?php if(auth()->user()->google_access_token): ?>
                    <div class="bg-green-50 border border-green-200 rounded-xl p-4 flex items-center justify-between">
                        ...
                        <form action="<?php echo e(route('settings.disconnect.google')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                    ...
                    <div class="bg-yellow-50 border border-yellow-200 rounded-xl p-4 flex items-center justify-between">
                        ...
                        <a href="<?php echo e(route('auth.google')); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-sm font-semibold transition">
...
<?php /**PATH C:\Users\MUSA\Documents\GitHub\Lomba2026\laravel-app\resources\views/settings/index.blade.php ENDPATH**/ ?>