            ...
            <div class="lg:col-span-2">
                <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-100">
                    ...
                    <div class="chat-container overflow-y-auto p-6 space-y-4 chat-scrollbar" id="chatMessages" x-ref="chatMessages">
                        ...
                        <?php else: ?>
                            <?php $__currentLoopData = $recentCommands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $command): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <!-- User Message -->
                                <div class="flex justify-end message-animation">
                                    <div class="bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-2xl rounded-tr-sm px-5 py-3 max-w-md shadow-lg">
                                        <p class="text-sm leading-relaxed"><?php echo e($command->command); ?></p>
                                        <div class="flex items-center justify-end mt-1 space-x-1">
                                            <span class="material-icons text-xs">schedule</span>
                                            <span class="text-xs text-indigo-100"><?php echo e($command->created_at->format('h:i A')); ?></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="flex justify-start message-animation">
                                    <div class="bg-gray-100 text-gray-800 rounded-2xl rounded-tl-sm px-5 py-3 max-w-md shadow-md border border-gray-200">
                                        ...
                                        <p class="text-sm leading-relaxed whitespace-pre-line"><?php echo e($command->response); ?></p>
                                        <div class="flex items-center mt-1 space-x-1">
                                            <span class="material-icons text-xs text-gray-400">schedule</span>
                                            <span class="text-xs text-gray-500"><?php echo e($command->created_at->addSeconds(1)->format('h:i A')); ?></span>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl shadow-xl p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold" x-text="messages.length + <?php echo e($recentCommands->count()); ?>"><?php echo e($recentCommands->count()); ?></p>
                        </div>
        ...
        function chatApp() {
            return {
                ...
                async clearHistory() {
                    ...
                    try {
                        const response = await fetch('<?php echo e(route("chat.clear")); ?>', {
                            method: 'DELETE',
                            headers: {
                                'Content-Type': 'application/json',
                                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
...
<?php /**PATH C:\Users\MUSA\Documents\GitHub\Lomba2026\laravel-app\resources\views/chat/index.blade.php ENDPATH**/ ?>